...
export class migration1658764607609 implements MigrationInterface {
    name = 'migration1658764607609'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "favorite_artists_artist" ADD CONSTRAINT "FK_fc6278dcd7f4ec83657af3d66c4" FOREIGN KEY ("favoriteId") REFERENCES "favorite"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "favorite_albums_album" ADD CONSTRAINT "FK_c2bdc9716bf0cf30d4275ceefcf" FOREIGN KEY ("favoriteId") REFERENCES "favorite"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "favorite_tracks_track" ADD CONSTRAINT "FK_eb76ffcbfc9c6a378285930a7a7" FOREIGN KEY ("favoriteId") REFERENCES "favorite"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
